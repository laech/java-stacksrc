  ...
  static class AssertDecoration implements TestExecutionExceptionHandler {
    ...
    private void assertEqualsFailure(Throwable e) {
      var expected =
          String.join(
              lineSeparator(),
              "stack.source.junit5.DecoratedAssertionError:",
              ...
              "\tat stack.source.junit5.ErrorDecoratorTest.decoratesFailure(ErrorDecoratorTest.java:20)",
              "",
              "\t   18    @Test",
    ...
    private void assertArrayEqualsFailure(Throwable e) {
      var expected =
          String.join(
              ...
              "\tat stack.source.junit5.ErrorDecoratorTest.decoratesArrayFailure(ErrorDecoratorTest.java:25)",
              "",
              "\t   23    @Test",
